...
function ModalValoracion({ pedidoId, socioId, establecimientoId, onClose }) {
  ...
  return (
    <div style={{
      position: 'fixed', inset: 0, background: 'rgba(15,15,15,0.55)', zIndex: 300,
    ...
    <div style={{ minHeight: '100vh', background: '#FAFAF7', fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div style={{ padding: '20px 20px 80px' }}>
        ...
        {etaMin && estado === 'en_camino' && (
          <div style={{
            background: 'rgba(255,107,44,0.10)', borderRadius: 14, padding: '14px 16px',
        ...
        {estado === 'nuevo' ? (
          <div style={{
            background: 'rgba(255,107,44,0.08)', borderRadius: 16, padding: '20px 16px',
          ...
          <div style={{
            background: 'rgba(22,163,74,0.08)', borderRadius: 16, padding: '20px 16px',
