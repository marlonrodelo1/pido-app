...
if (missingVars.length > 0) {
  ...
  wrap.style.cssText = 'display:flex;align-items:center;justify-content:center;height:100vh;background:#F7F3EC;color:#B5564A;font-family:sans-serif;padding:20px;text-align:center'
