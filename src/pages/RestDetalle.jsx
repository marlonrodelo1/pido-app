...
import { ArrowLeft, MapPin, Star, Bike, ShoppingBag, UtensilsCrossed, Plus, Minus, Video } from 'lucide-react'
...
export default function RestDetalle({ establecimiento, onBack, modoTienda = false, onRequireLogin, onOpenCreadores = null, socioData = null }) {
  ...
  return (
    <div style={{
      ...
      {/* Pidoo Creadores. El bloque vive en `components/CreadoresBloqueRest`
          porque la tienda pública de escritorio (`TiendaDesktop`) enseña el
          mismo, y duplicarlo era garantizar que acabaran diciendo cosas
          distintas. */}
      <div style={{ background: C.cream }}>
        <CreadoresBloqueRest programa={creadores} onOpenCreadores={onOpenCreadores} />
      </div>
