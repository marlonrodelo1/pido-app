// Pagina publica de seguimiento de pedido por codigo PD-XXXXXX.
// Sustituye al iframe Shipday cuando el restaurante usa el dispatcher propio.
// Ruta: /seguir/:codigo
          ...
          <div style={S.section}>
            {rider ? (
              ...
              <div style={{ textAlign: 'center', padding: '12px 0' }}>
                <div style={{ fontSize: 24, marginBottom: 6, animation: 'pulse 1.5s ease-in-out infinite' }}>🛵</div>
...
const S = {
  wrap: {
    ...
    padding: '20px 14px', fontFamily: 'system-ui, -apple-system, sans-serif',
