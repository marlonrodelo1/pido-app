          ...
          <div key={p.id} style={{ background: 'rgba(0,0,0,0.06)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)', borderRadius: 14, padding: '14px 16px', border: '1px solid rgba(0,0,0,0.08)', marginBottom: 10 }}>
            ...
            {p.estado === 'entregado' && (
              <button onClick={() => repetirPedido(p)} style={{
                width: '100%', marginTop: 10, padding: '9px 0', borderRadius: 12,
                border: repetido === p.id ? '1px solid rgba(34,197,94,0.3)' : '1px solid rgba(0,0,0,0.08)',
                background: repetido === p.id ? 'rgba(34,197,94,0.08)' : 'rgba(0,0,0,0.06)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)',
